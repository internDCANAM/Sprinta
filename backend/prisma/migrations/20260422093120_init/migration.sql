...
-- CreateEnum
CREATE TYPE "DealType" AS ENUM ('SLUTAVVERKNING', 'GALLRING', 'ENERGIVIRKE', 'OVRIGT');

-- CreateEnum
CREATE TYPE "DealStatus" AS ENUM ('PLANERAD', 'PAGAENDE', 'KLAR', 'FAKTURERAD', 'AVSLUTAD');

-- CreateEnum
CREATE TYPE "DealEventType" AS ENUM ('AVTAL_SIGNERAT', 'AVVERKNING_START', 'AVVERKNING_SLUT', 'MATBESKED', 'UTBETALNING', 'OVRIGT');

-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('AVTAL', 'AVRAKNING', 'MATBESKED', 'STANFORD', 'OVRIGT');

-- CreateEnum
CREATE TYPE "MessageSenderRole" AS ENUM ('CUSTOMER', 'ADMIN');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PLANERAD', 'GENOMFORD', 'MISSLYCKAD');
